...
$plugin = plugin::byId('openvpnOVPN');
...
<div class="row row-overflow">
	<div class="col-xs-12 eqLogicThumbnailDisplay">
		...
		<legend><i class="fas fa-archway"></i> {{Mes openvpnOVPNs}}</legend>
						...
						<form class="form-horizontal">
							<fieldset>
								<div class="form-group">
									<label class="col-sm-4 control-label">{{Nom de l'équipement openvpnOVPN}}</label>
									<div class="col-sm-4">
										<input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
										<input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement openvpnOVPN}}"/>
									</div>
								</div>
								<div class="form-group">
...
<?php
include_file('desktop', 'openvpnOVPN', 'js', 'openvpnOVPN');
